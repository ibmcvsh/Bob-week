...
// Add click tracking for lab links (optional analytics)
document.querySelectorAll('.lab-link').forEach(link => {
    link.addEventListener('click', function(e) {
        const labName = this.closest('.lab-card').querySelector('h3').textContent;
        console.log(`Lab clicked: ${labName}`);
...
// Add copy to clipboard functionality for code snippets (if needed in future)
...
console.log('Bob Week 2026 website loaded successfully! 🚀');
