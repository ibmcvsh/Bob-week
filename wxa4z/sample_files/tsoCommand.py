...
@tool(name="tsoCommand", 
      description="Issues a TSO command through the z/OSMF REST console services. The command is executed and then returns the command response", 
...
def tsoCommand(tsoCmd: str) -> str:
    ...
    cmd_response=status_data['cmdResponse']
    #cmd_response=status_data['cmdResponse'].replace('\r', '\n')
    return cmd_response
